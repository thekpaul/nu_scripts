# Tested on Nushell 0.104.0 with bat 0.25.0 (25f4f96)

# A cat(1) clone with syntax highlighting and Git integration
export extern "bat" [
    ...file: path  # file(s) to print / concatenate
    --help         # Print help (see a summary with '-h')
    -h             # Print help (see more with '^bat --help')
    ...
    --binary: string@"nu-complete binary" # How to treat binary content (default: no-printing)
    ...
    --highlight-line(-H): string  # <N:M> Highlight from N to M line range with a different background color
    ...
    --wrap: string@"nu-complete wrap-modes"  # Specify the text-wrapping mode
    ...
    --theme-light # Sets the color theme for syntax highlighting used for light backgrounds
    --theme-dark # Sets the color theme for syntax highlighting used for dark backgrounds
    --list-themes    # Display a list of supported themes for syntax highlighting
    --squeeze-blank(-s) # Squeeze consecutive empty lines
    --squeeze-limit: number # Set the maximum number of consecutive empty lines to be printed
    --strip-ansi: string@"nu-complete when" # Specify when to strip ANSI escape sequences from the input
    ...
    --completion: string@"nu-complete shell" # Show shell completion for a certain shell [possible values: bash, fish, zsh, ps1]
    ...
    --config-dir # Print configuration directory
]
...
def "nu-complete binary" [] {
    ['no-printing', 'as-text']
}

def "nu-complete shell" [] {
    ['bash', 'fish', 'zsh', 'ps1']
}
